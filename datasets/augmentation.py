...
def get_augumentation(phase, width=512, height=512, min_area=0.0, min_visibility=0.0):
    list_transforms = []
    if phase == "train":
        list_transforms.extend(
            [
                ...
                albu.augmentations.transforms.RandomResizedCrop(
                    height=height, width=width, p=0.3
                ),
                ...
                albu.OneOf(
                    [
                        albu.RandomBrightnessContrast(
                            brightness_limit=0.5, contrast_limit=0.4
                        ),
