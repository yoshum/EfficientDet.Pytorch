...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="EfficientDet Training With Pytorch")
    ...
    parser.add_argument(
        "-t", "--threshold", default=0.4, type=float, help="Visualization threshold"
    )
    parser.add_argument(
        "-it",
        "--iou_threshold",
    ...
    parser.add_argument(
        "--weight",
        default="./checkpoint_VOC_efficientdet-d0_248.pth",
        type=str,
